...
import os
# blob connection
connect_str = os.getenv('AzureWebJobsStorage') # global env inside the function app
conn = "DefaultEndpointsProtocol=https;AccountName=<accountName>;AccountKey=<accountKey>;EndpointSuffix=core.windows.net" # using connetion string inside code
