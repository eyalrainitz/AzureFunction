...
const App = () => {
  ...
  const SendName = async (name) => {
    if (name !== null || name !== "" || name !== " ") {
      await axios
        .post("https://selafunctionpocnode.azurewebsites.net/api/BlobPost", {
          name,
        })
        .then((res) => {
          setResData(res.data);
  ...
  const cosmosGetnode = async () => {
    await axios
      .get("https://selafunctionpocnode.azurewebsites.net/api/CosmosGet")
      .then((res) => setcosmosGet([...res.data]));
  };
  const CosmosPostNode = async (name) => {
    await axios
      .post("https://selafunctionpocnode.azurewebsites.net/api/CosmosPost", {
        name,
      })
      .then((res) => setcosmosGet([...res.data]));
  };
  ...
  const GetName = async (name) => {
    await axios
      .get(
        `https://selafunctionpocnode.azurewebsites.net/api/BlobGet/?name=${name}`
      )
  ...
  const CosmosGetPython = async () => {
    await axios
      .get(`https://selafunctionpython.azurewebsites.net/api/CosmosGet?`)
  ...
  const CosmosPostPython = (name) => {
    axios
      .post(`https://selafunctionpython.azurewebsites.net/api/CosomosPost`, {
        name,
      })
  ...
  const HttpBlobGetPython = (name) => {
    axios
      .get(
        `https://selafunctionpython.azurewebsites.net/api/HttpBlob/?name=${name}`
      )
  ...
  const HttpBlobPostPython = (name) => {
    axios
      .post(`https://selafunctionpython.azurewebsites.net/api/HttpBlobPost`, {
        name,
      })
  ...
  return (
    <div className="App">
      ...
      <div>
        <label>Get Count of items in cosmos db</label>
